...
class CObject_EndPressanykey : public CObject {
protected:
	glm::vec3 size;
	bool inBox;
	int type;
	bool clicked;
public:
	CObject_EndPressanykey(CCamera& cam, glm::vec3 size = glm::vec3{ 1,1,1 }, glm::vec3 pos = glm::vec3{ 0,0,0 }, glm::mat4 proj = PROJ(60.f));
