...
private:
	...
	GLuint CreateVec3VBO(vec3Buffer& pBuffer, GLuint* VBO, GLuint VBONumber);
	void InitShaderProgram();


public:
	CShader(GLuint layoutSize, vec3Buffer* pBuf);
	void DrawObject(std::vector<GLuint>& pIndex, GLuint DrawType);
	void Update(glm::mat4 world, glm::mat4 camera, glm::mat4 mat_Projection, vec3Buffer* pBuf);
	void UseProgram();
};